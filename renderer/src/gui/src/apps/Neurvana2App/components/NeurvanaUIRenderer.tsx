...
import './NeurvanaUIRenderer.scss';
import { UIViewInfo, useNeurvanaAppStore } from '../store/neurvanaAppStore';
 ...
 */
const NeurvanaUIRenderer: React.FC<NeurvanaUIRendererProps> = ({ 
  uiViewId, 
  projectId,
  ...
  const { openUIViews } = useNeurvanaAppStore(windowId, spaceId);
...
export default NeurvanaUIRenderer; 