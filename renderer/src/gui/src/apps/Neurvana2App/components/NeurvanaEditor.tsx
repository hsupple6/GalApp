...
import './NeurvanaEditor.scss';
import { useNeurvanaAppStore } from '../store/neurvanaAppStore';
...
export interface NeurvanaEditorProps {
  fileId: string | null;
  projectId: string | null;
}

const NeurvanaEditor: React.FC<NeurvanaEditorProps> = ({ fileId, projectId }) => {
  ...
  const { openFiles } = useNeurvanaAppStore('', ''); // These will be filled properly when the component is used
